...
if($_POST['submit']){
	...
	$sql = "INSERT INTO `db_research`.`tb_tj_theses` (`id`, `uid`, `date`, `name`, `papercategory`, `sname`, `period`, `author`, `status`, `level`, `other`, `source`, `number`, `remarks`)
			VALUES ('', '$uid', '$date', '$name', '$papercategory', '$sname', '$period', '$author', '$status', '$level', '$other', '$source', '$number', '$remarks')";
