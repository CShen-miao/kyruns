...
if($_POST['submit']){
	...
	$sql = "INSERT INTO `db_research`.`tb_tj_underpro` (`id`, `uid`, `date`, `name`, `scate`, `number`, `source`, `cycle`, `charge`, `funds`, `remarks`)
			VALUES ('', '$uid', '$date', '$name','$scate', '$number', '$source', '$cycle', '$charge', '$funds', '$remarks')";
