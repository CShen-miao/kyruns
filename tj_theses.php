		    ...
		    <form role="form"  action="do_tj_theses.php" method="post" name="myform" onsubmit="return CheckPost();">
				...
				<div class="form-group col-lg-8" style="padding-top:15px;">
			     ...
			     <div class="form-group col-lg-8">
                    ...
                    <div class="form-group">
						<select class="form-control input-sm" id="name5" name="papercategory">
							<option value=""></option>
				...
				<div class="col-lg-12" style="padding-top:15px;">
				  <label for="name" class="fontTitle">论文级别（<span class="fontStar">※</span>）</label><br>
				   ...
				   <label class="checkbox-inline">
					  <input type="radio" name="level" id="radioInline11" value="其他：">其他：<input id="textInfo" name="" type="text" class="form-control input-sm" style="display:inline; width:auto; height:auto;">
				   </label>
				</div>
