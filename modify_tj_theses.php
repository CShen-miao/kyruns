	...
	<div class="row" style="padding-top:15px;">
		...
		<div class="col-md-5" style="background-color:rgb(255,255,255);margin-right:30px;">
			...
			<div class="row-fluid col-md-12" style="padding-top:5px;">
			    ...
			    <div class="form-group col-lg-8">
				    <label for="name" class="fontTitle">论文类别（<span class="fontStar">※</span>）</label>
                    <div class="form-group">
						<select class="form-control input-sm" id="name5" name="papercategory" value="<?php echo $row['papercategory']; ?>">
							<option value=""></option>
				...
				<div class="col-lg-12" style="padding-top:15px;">
				  <label for="name" class="fontTitle">论文级别（<span class="fontStar">※</span>）</label><br>
				   <label class="checkbox-inline">
				     ...
				     <label class="checkbox-inline">
					  <input type="radio" name="level" id="radioInline6" value="EI期刊">EI期刊
				   </label>
				    <label class="checkbox-inline">
					  <input type="radio" name="level" id="radioInline7" value="EI会议">EI会议
				   </label>
				   <label class="checkbox-inline">
					  <input type="radio" name="level" id="radioInline8" value="ISTP收录">ISTP收录
				   </label>
				   <label class="checkbox-inline">
					  <input type="radio" name="level" id="radioInline9" value="核心期刊">核心期刊
				   </label><br>
				   <label class="checkbox-inline">
					  <input type="radio" name="level" id="radioInline10" value="普通期刊">普通期刊
				   </label><br>
				   <label class="checkbox-inline">
					  <input type="radio" name="level" id="radioInline11" value="其他">其他：<input type="text" value="<?php if($row['level']=='其他'){echo $row['other'];}?>" class="form-control input-sm" style="display:inline; width:auto; height:auto;" id="textInfo" name="other">
				   </label>
				</div>
