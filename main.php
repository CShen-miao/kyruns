            ...
            <div class="item active">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        <h1>科 研 统 计</h1>
                        <p>信息科学与工程学院科研统计      点击下方按钮进入科研统计页。                 科研统计共7大类 ，包括：论文统计  荣誉奖项  著作教材   学生竞赛统计 作品产业化  知识产权  教师承担项目统计。</p>
		...
		<div class="col-md-10">
			...
			<p class="text-center" style="color:#6D6D6D; padding-top:30px; padding-bottom:50px; ">
				...
				<strong>科研管理系统 </strong> 
				            ...
				            科研统计包括：统计论文、教师承担科研项目、科研获奖 、知识产权、学生竞赛情况 、作品产业化、著作教材七项内容；项目进行申报后需等待管理员的审核，<br>
				...
				<div class="col-md-4 col-xs-4">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<p>
									您可以点击此处，进行查看统计，一共包括七项内容：论文统计、教师承担项目、科研获奖、知识产权专利、学生竞赛、著作教材及作品产业化统计。
							</p>
							<p>
